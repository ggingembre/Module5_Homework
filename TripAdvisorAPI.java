...
public class TripAdvisorAPI implements API {
        ...
        public TripAdvisorAPI() throws ParseException {   // empty constructor
            ...
            rooms[0] = new Room(123,1000,4, date1,"Mercure","Paris");
            rooms[1] = new Room(124,100,2, date2,"Hostel Soho","London");
            rooms[2] = new Room(125,500,2, date3,"Radisson Blue","Kiev");
            rooms[3] = new Room(126,1000,2, date4,"Intercontinental","Kiev");
            rooms[4] = new Room(127,900,2, date5,"Premier Inn","Kiev");
        }
